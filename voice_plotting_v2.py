...
ue_deep_ue1 = read_output('ue_1_deep.txt')
ue_tabular_ue1 = read_output('ue_1_tabular.txt')
ue_fpa_ue1 = read_output('ue_1_fpa.txt')

ue_deep_ue2 = read_output('ue_2_deep.txt')
ue_tabular_ue2 = read_output('ue_2_tabular.txt')
ue_fpa_ue2 = read_output('ue_2_fpa.txt')
